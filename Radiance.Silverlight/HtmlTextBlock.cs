...
namespace Radiance
{
    public class HtmlTextBlock : Control
    {
		...
		protected const string elementUL = "UL";
		protected const string elementLI = "LI";
		protected const string elementDIV = "DIV";
                            ...
                            case XmlNodeType.Element:
                                ...
                                switch (nameUpper)
                                {
                                    case elementA:
                                        ...
                                        break;
                                    case elementB: case elementSTRONG: bold++; break;
                                    case elementI: case elementEM: italic++; break;
