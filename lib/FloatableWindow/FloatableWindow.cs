...
namespace System.Windows.Controls
{
    ...
    public class FloatableWindow : ContentControl
    {
		...
		public event EventHandler<CancelEventArgs> Minimizing = delegate { };
		...
		/// <summary>
		/// Gets the internal accessor for the mininze button of the window.
		/// </summary>
...
//#endif
		...
		internal void MinimizeButton_Click(object sender, RoutedEventArgs e)
		{
			...
			this.Minimizing(this, cancelArgs);
...
//#endif
        ...
        private void Chrome_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (this._chrome != null)
            {
				...
				this.DragCompleted(this, EventArgs.Empty);
            }
        }
        ...
        private void Chrome_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (this._isMouseCaptured && this.ContentRoot != null)
            {
				...
				var deltaX = position.X - _mousePosition.X;
				var deltaY = position.Y - _mousePosition.Y;
		...
		{
			//var transformGroup = this.ContentRoot.RenderTransform as TransformGroup;
			//if (transformGroup != null)
			//{
			...
			//        {
			//            var translate = t as TranslateTransform;
		...
		{
			EventHandler handler = this.Minimized;
		...
		{
			EventHandler<CancelEventArgs> handler = this.Minimizing;
...
//#endif
                ...
                if ((p.X > this._clickPoint.X) && (p.Y > this._clickPoint.Y))
                {
					...
					this.OnResized(this, EventArgs.Empty);
                }
            }
        }
